...
export default function Navbar() {
  return (
    <div className="fixed inset-x-0 max-w-2xl mx-auto z-50 top-2">
      <div className="relative rounded-full boder bg-black border-white/[0.2] border-b-2 flex justify-around space-x-10 px-4 py-5 md:py-7 backdrop-filter backdrop-blur-lg shadow-inner shadow-neutral-400">
